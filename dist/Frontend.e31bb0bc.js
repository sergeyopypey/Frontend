...
},{}],"Controllers/licenseController.js":[function(require,module,exports) {
"use strict";
...
function _sendLicense() {
  _sendLicense = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var title, lic_number, author, lic_owner, expiration_date, recieved_date, date, owner, user_id, license, url, response, json;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
function _showLicenseTab() {
  _showLicenseTab = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var tablinks, i;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _licenseController.getLicenses)();
          case 7:
          case "end":
            return _context.stop();
        }
...
},{"./helper":"helper.js","./Controllers/licenseController":"Controllers/licenseController.js","./Controllers/userController":"Controllers/userController.js"}],"index.js":[function(require,module,exports) {
"use strict";
