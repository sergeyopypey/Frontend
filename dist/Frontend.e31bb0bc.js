...
},{}],"licenseController.js":[function(require,module,exports) {
"use strict";
...
function _sendLicense() {
  _sendLicense = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var title, lic_number, author, lic_owner, inspired_date, recieved_date, license, url, response, json;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            inspired_date = document.getElementById('inspired_date');
