        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            for (i = 0; i < json_size; i++) {
              $site.insertAdjacentHTML('beforeend', "<option>".concat(json[i].user_name, "</option>"));
            }
          case 14:
          case "end":
...
function _sendLicense() {
  _sendLicense = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var title, lic_number, author, lic_owner, expiration_date, recieved_date, date, license, url, response, json;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
